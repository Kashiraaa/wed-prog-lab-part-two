...
@lab9.route('/lab9/happen', methods=['GET'])
def card():
    ...
    return render_template('lab9/happen.html', sender_name=sender_name, recipient_gender=recipient_gender, recipient_name=recipient_name)
